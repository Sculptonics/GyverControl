...
#define USE_PLOTS 1           // 1 - включить, 0 - отключить вывод графиков
#define USE_DAWN 0            // включает/отключает поддержку режима РАССВЕТ на каналах 2, 3, серво1, серво2
#define USE_DRIVE 1           // включает/отключает поддержку линейного привода (в целях экономии памяти)
...
#define USE_CO2 1           // 1 - использовать MH-Z19, 0 - не использовать
